...
return [
    ...
    'hero' => [
        ...
        'subtitle' => 'Terhubung dengan ribuan pelajar, instruktur, dan profesional industri dari seluruh dunia.',
    ...
    'guidelines' => [
        ...
        'subtitle' => 'Bantu kami menjaga lingkungan yang positif dan inklusif untuk semua orang.',
        'be_respectful' => [
            'title' => 'Hormati',
            'description' => 'Perlakukan semua anggota komunitas dengan hormat dan baik hati, terlepas dari latar belakang atau tingkat pengalaman mereka.'
        ],
        'stay_relevant' => [
            'title' => 'Tetap Relevan',
            'description' => 'Jaga diskusi fokus pada pembelajaran, pengembangan karir, dan topik terkait.'
        ],
        'help_others' => [
            'title' => 'Bantu Orang Lain',
            'description' => 'Bagikan pengetahuan Anda dan dukung sesama pelajar dalam perjalanan pendidikan mereka.'
        ],
        'no_spam' => [
            'title' => 'Tidak Ada Spam',
            'description' => 'Hindari memposting konten promosi, spam, atau iklan yang tidak terkait.'
        ]
    ],
    ...
    'testimonials' => [
        ...
        'subtitle' => 'Dengar dari anggota komunitas kami tentang pengalaman mereka.'
    ],
