...
return [
    ...
    'hero' => [
        'title' => 'Produk Kami',
        'subtitle' => 'Jelajahi berbagai produk komprehensif kami yang dirancang untuk membantu Anda menguasai keterampilan baru dan memajukan karir Anda.'
    ],
    ...
    // Course Features
    'features' => [
        'title' => 'Mengapa Belajar Bersama Kami?',
        'subtitle' => 'Kami menyediakan pengalaman belajar terbaik dengan fitur-fitur komprehensif.',
        'certificate' => [
            'title' => 'Sertifikat',
            'description' => 'Terima sertifikat yang diakui industri setelah penyelesaian'
        ],
        'lifetime_access' => [
            'title' => 'Akses Seumur Hidup',
            'description' => 'Dapatkan akses seumur hidup ke materi dan pembaruan'
        ],
        'mobile_access' => [
            'title' => 'Akses Mobile',
            'description' => 'Belajar di perjalanan dengan aplikasi mobile kami'
        ],
        'support_24_7' => [
            'title' => 'Dukungan 24/7',
            'description' => 'Dapatkan bantuan kapan pun Anda membutuhkannya'
        ]
    ],
    ...
    'product_details' => [
        ...
        'not_exist' => 'Produk yang Anda cari tidak ada.',
        'browse_all' => 'Jelajahi Semua Produk',
        'course_includes' => 'Produk Termasuk:',
        'duration' => 'Durasi',
        'level' => 'Level',
        'save' => 'Hemat',
        ...
        'key_skills' => 'Keterampilan Utama',
        'career_benefits' => 'Manfaat Karir'
    ],
    ...
    'cta' => [
        ...
        'request_course' => 'Ajukan Produk',
        'explore_bootcamps' => 'Jelajahi Bootcamps',
        'enroll_now' => 'Daftar di Produk Ini'
    ],

    // Load More
    'load_more' => [
        'courses' => 'Muat Lebih Banyak Produk'
    ],

    // Product Detail Page
    'detail' => [
        'master_fundamentals' => 'Kuasai dasar-dasar',
        'build_projects' => 'Bangun proyek dunia nyata dan portofolio',
        'learn_practices' => 'Pelajari praktik dan standar industri terbaik',
        'develop_skills' => 'Kembangkan keterampilan pemecahan masalah dan berpikir kritis',
        'enhance_resume' => 'Tingkatkan resume Anda dengan keterampilan yang diminati',
