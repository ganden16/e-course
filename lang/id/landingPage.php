...
return [
    ...
    'features' => [
        ...
        'learn_anywhere' => [
            ...
            'description' => 'Akses kursus kami dari perangkat apa pun, di mana pun di dunia. Belajar dengan kecepatan Anda sendiri.'
        ],
        'certified_courses' => [
            'title' => 'Kursus Bersertifikat',
            'description' => 'Terima sertifikat yang diakui industri setelah menyelesaikan kursus kami.'
        ],
        'expert_instructors' => [
            'title' => 'Instruktur Ahli',
            'description' => 'Belajar dari ahli industri dengan pengalaman praktis bertahun-tahun.'
        ],
        'support_24_7' => [
            'title' => 'Dukungan 24/7',
            'description' => 'Dapatkan bantuan kapan pun Anda membutuhkannya dengan tim dukungan kami yang siaga 24 jam.'
        ],
        'track_progress' => [
            'title' => 'Lacak Kemajuan',
            'description' => 'Pantau kemajuan pembelajaran Anda dengan alat analitik canggih kami.'
        ],
        'affordable_price' => [
            'title' => 'Harga Terjangkau',
            'description' => 'Dapatkan pendidikan berkualitas dengan harga yang tidak akan menguras kantong Anda.'
        ]
    ],
