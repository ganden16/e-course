...
return [
    ...
    'featured_courses' => [
        ...
        'data' => [
            [
                ...
                'description' => 'Pelajari pengembangan web dari nol dengan HTML, CSS, JavaScript, React, Node.js, dan lainnya.'
            ],
            [
                'id' => 2,
                'title' => 'Python untuk Ilmu Data',
                'category' => 'Ilmu Data',
                'price' => 799000,
                ...
                'duration' => '36 hours',
                'level' => 'Menengah',
                'description' => 'Kuasai pemrograman Python untuk ilmu data, machine learning, dan analisis data.'
            ],
            [
                'id' => 3,
                'title' => 'Penguasaan Pemasaran Digital',
                'category' => 'Pemasaran',
                'price' => 699000,
                ...
                'duration' => '28 hours',
                'level' => 'Pemula',
                'description' => 'Pelajari strategi pemasaran digital termasuk SEO, media sosial, pemasaran konten, dan lainnya.'
            ]
        ]
    ],
    ...
    'upcoming_bootcamps' => [
        ...
        'data' => [
            [
                ...
                'description' => 'Bootcamp intensif 12 minggu yang mencakup pengembangan front-end dan back-end, database, dan deployment.'
            ],
            [
                'id' => 2,
                'title' => 'Bootcamp Ilmu Data & Machine Learning',
                'category' => 'Ilmu Data',
                'price' => 6999000,
                ...
                'description' => 'Bootcamp ilmu data komprehensif yang mencakup statistik, machine learning, dan visualisasi data.'
            ]
        ]
    ],
    ...
    // Latest Blog Section
    'latest_blog' => [
        'title' => 'Terbaru dari Blog Kami',
        'subtitle' => 'Tetap update dengan tren dan wawasan terbaru dalam teknologi dan pendidikan.',
        ...
        'data' => [
            [
                ...
                'excerpt' => 'Jelajahi tren terbaru yang membentuk masa depan pengembangan web, dari alat bertenaga AI hingga kerangka kerja canggih.',
            ...
            [
                'id' => 2,
                'title' => 'Memulai dengan Machine Learning: Panduan untuk Pemula',
                'excerpt' => 'Pelajari dasar-dasar machine learning dan cara memulai perjalanan Anda untuk menjadi insinyur ML.',
            ...
            [
                'id' => 3,
                'title' => 'Strategi Pemasaran Digital yang Efektif untuk Usaha Kecil',
                'excerpt' => 'Temukan strategi pemasaran digital yang hemat biaya yang dapat membantu usaha kecil bersaing dengan pesaing yang lebih besar.',
