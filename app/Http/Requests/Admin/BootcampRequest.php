...
class BootcampRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'career_support' => 'nullable|array',
            'career_support.*' => 'nullable|string|max:255',
            ...
            'modules.*.week_number' => 'nullable|integer|min:1',
            'modules.*.module' => 'nullable|string|max:255',
            'modules.*.objective' => 'nullable|string',
            'modules.*.description' => 'nullable|string',
            'modules.*.topics' => 'nullable|string',
    ...
    public function attributes(): array
    {
        return [
            ...
            'mentors' => 'Mentor',
            'modules' => 'Modul Pelatihan',
            'modules.*.week_number' => 'Nomor Minggu',
            'modules.*.module' => 'Nama Modul',
            'modules.*.objective' => 'Tujuan Pembelajaran',
            'modules.*.description' => 'Deskripsi Modul',
            'modules.*.topics' => 'Topik',
            'modules.*.duration_hours' => 'Durasi (jam)',
            'modules.*.is_active' => 'Status Aktif Modul',
        ];
    }
}
