...
<section class="min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <!-- Use hero image from bootcamp page -->
        <div class="w-full h-full bg-cover bg-center" style="background-image: url('{{ $bootcamps[0]['image'] ?? asset('assets/images/logo1.png') }}');">
            <!-- Dark Overlay -->
    ...
    <div class="container mx-auto px-6 py-20 relative z-10">
        <div class="text-center max-w-4xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="#bootcamps" class="bg-primary hover:bg-primary-dark text-white font-bold py-4 px-10 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl">
                    {{ $cta['apply_now'] }}
                </a>
                <a href="{{ $baseUrl }}/contact" class="hover:bg-white hover:text-primary border border-white text-white font-bold py-4 px-10 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl">
