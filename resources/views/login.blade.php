...
<head>
    ...
    <title>Login - EduTech Academy</title>
            ...
            <div class="flex flex-col lg:flex-row items-center justify-center bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div class="w-full lg:w-1/2 p-8 lg:p-12">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800">EduTech Academy</h2>
                    ...
                    <form class="space-y-6">
                        ...
                        <div class="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                            <p class="text-xs text-blue-800">
                                ...
                                <span x-show="selectedRole === 'admin'">Demo Admin: admin@edutech.com / admin123</span>
                                <span x-show="selectedRole === 'mentor'">Demo Mentor: mentor@edutech.com / mentor123</span>
                                <span x-show="selectedRole === 'user'">Demo User: user@edutech.com / user123</span>
                            </p>
                        </div>
                    </form>
