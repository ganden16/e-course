...
@section('title', isset($admin) ? 'Detail Admin' : 'Tambah Admin')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <!-- Image Info -->
                                <div class="flex-1">
                                    <p class="text-sm text-gray-600">Foto profil admin</p>
                        ...
                        <div>
                            ...
                            <input type="text"
                                   value="{{ $admin->updated_at->format('d M Y H:i') }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed"
                                   readonly>
                        </div>
                    </div>
...
function previewImage(event) {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            const previewContainer = event.target.closest('.flex').querySelector('img, .h-20');
